            ...
            @if($loaded)
                ...
                <div class="inline-block w-full">
                    ...
                    <x-dialog dialogId="linkdialog">
                        ...
                        <div
                            class="p-1.5 flex flex-col sm:flex-row items-center gap-2 border border-gray-300 rounded-lg"
                            x-data>
                        ...
                        <p wire:stream="linkFetchStatus"
                           class="text-xs text-gray-600 mt-4 text-center font-semibold"></p>
