        ...
        <nav class="size-full flex flex-col">
            ...
            <div class="mt-auto">
                <div class="border-t border-gray-200 dark:border-neutral-700">
                    <a class="flex justify-between items-center gap-x-3 py-2 px-3 uppercase text-sm text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:hover:bg-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-300 dark:focus:text-neutral-300" href="#">
                        GeminiPro-1.5
                        <x-icons.settings/>
                    </a>
                </div>
            ...
            <div class="flex w-full items-center">
                <div class="flex w-full flex-col gap-1.5 rounded-full p-1 transition-colors bg-gray-200 dark:bg-token-main-surface-secondary">
                    <div class="flex items-end gap-1.5 md:gap-2">
                        ...
                        <button data-testid="send-button" class="mb-1 me-1 flex h-8 w-8 items-center justify-center rounded-full bg-black text-white transition-colors hover:opacity-70 focus-visible:outline-none focus-visible:outline-black disabled:bg-gray-400 disabled:text-[#f4f4f4] disabled:hover:opacity-100" disabled>
