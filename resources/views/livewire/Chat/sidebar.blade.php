...
<div id="hs-application-sidebar"
     class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full duration-300 transform hidden fixed z-10 top-12 bg-white w-64 h-screen border-e border-gray-200 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500 dark:bg-neutral-900 dark:border-neutral-700"
        ...
        <div class="h-full overflow-y-auto flex-1">
            ...
            <ul class="space-y-0">
                @if(hasApiKeysCreated())
                    <li class="p-3">
                        <x-gradient-link class="w-full" href="/{{$tools['chat-buddy']['route']}}" wire:navigate.hover>
