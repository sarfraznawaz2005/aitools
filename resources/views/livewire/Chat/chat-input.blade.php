<div class="w-full lg:left-64 lg:w-[calc(100%-16rem)] mx-auto fixed bottom-0 z-10 p-4 px-8 bg-gray-50">
    ...
    <div class="flex w-full items-center" x-data="{
        ...
        <div
            ...
            <div class="flex gap-2 items-center">
                ...
                <div class="inline-block text-2xl ml-1" x-data x-tooltip.raw="{{$bot->name ?? 'General'}}">
