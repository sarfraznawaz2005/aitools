...
<!-- sidebar start -->
<div id="hs-application-sidebar" class="transition-all pr-2 min-h-screen fixed top-14 z-[60] duration-300 inset-y-0 start-0 bg-white border-e border-gray-200 dark:bg-neutral-900 dark:border-neutral-700" role="dialog" tabindex="-1" aria-label="Sidebar" style="min-height: 92vh;">
